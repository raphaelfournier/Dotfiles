...
local helpers = require("saimoomedits.helpers")
local wibox = require("wibox")
local gears = require("gears")
local rubato = require("saimoomedits.mods.rubato")
local readwrite = require("saimoomedits.misc.scripts.read_writer")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- widgets
    --~~~~~~~~
    --local profile = require("controlcenter.profile")
    local sessions = require("controlcenter.sessionctl")
    local sliders = require("controlcenter.sliders")
    local song = require("controlcenter.music")
    local services = require("controlcenter.services")
    local statusline = require("controlcenter.statusbar")
