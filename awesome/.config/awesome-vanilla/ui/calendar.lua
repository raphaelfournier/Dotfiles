...
local calendar_styles = {
    month = {
        padding      = dpi(2),
        bg_color     = beautiful.si_inner_bg,
        --bg_color     = "#3F3F3F",
        border_width = 0,
    ...
    focus = {
        border_width = dpi(0),
        bg_color     = beautiful.fg_urgent or "#dcdccccc",
        --bg_color     = beautiful.fg_urgent or "#CC9393",
        shape        = beautiful.si_outer_border_shape,
        --fg_color = '#7788af',
        markup   = function(t) return '<span color="#1E2320">' .. t .. '</span>' end,
    },
    header = {
...
local function decorate_calendar(widget, flag, date)
    ...
    local default_bg = (weekday==0 or weekday==6) and beautiful.darkGrey or beautiful.black
    local ret = wibox.widget {
        ...
        shape_border_color = props.border_color or beautiful.darkGrey,
        shape_border_width = props.border_width or 0,
        fg                 = "#dcdccc" or beautiful.white,
