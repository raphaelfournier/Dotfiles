...
if &t_Co > 255
    ...
    " spellchecking, modified
    hi SpellLocal ctermbg=236  ctermfg=14 cterm=bold,underline
    hi SpellBad   ctermbg=236 ctermfg=174 cterm=bold,underline
    hi SpellCap   ctermbg=236  ctermfg=12 cterm=bold,underline
    hi SpellRare  ctermbg=236  ctermfg=13 cterm=bold,underline
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    if &t_Co > 255
        ...
        hi FoldColumn    ctermbg=236 ctermfg=109
        hi Folded        ctermbg=236 ctermfg=109
        hi TabLine       ctermbg=240 ctermfg=250 cterm=none
        hi TabLineSel    ctermbg=250 ctermfg=240 cterm=bold
        hi TabLineFill   ctermbg=236 ctermfg=233
    endif
endif
